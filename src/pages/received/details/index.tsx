...
const DetailsReceived = ({ data, toggle }: DetailsReceivedProps) => {
                    ...
                    <Card>
                        <CardContent>
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                                ...
                                <Typography variant="body2">
                                    <strong>Teléfono:</strong> {data?.userId?.phone || 'No tiene'}
                                </Typography>
                            </Box>
                            <Divider />
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2 }}>
                                <Typography variant="body2">
                                    <strong>Agresor:</strong> {data?.otherAggressor || data?.aggressor?.name || 'Desconocido'}
                                </Typography>
                            </Box>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2 }}>
                                <Typography variant="body2">
                ...
                <Grid item xs={12}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 4 }}>
                        <ButtonGroup variant="outlined" aria-label="Basic button group">
                            <Button color="error" disabled={data?.status === 'refused'}>Rechazar</Button>
                            <Button color="success" disabled={data?.status === 'accepted'}>Atender</Button>
                        </ButtonGroup>
