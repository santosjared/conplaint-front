        ...
        <Dialog fullWidth open={open} maxWidth='lg' scroll='body' onClose={toggle} TransitionComponent={Transition}>
            <DialogContent>
                ...
                <Box sx={{ backgroundColor: theme => theme.palette.background.paper, p: 4, borderRadius: 2 }}>
                    {rows.length > 0 && <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap', alignItems: 'center', mb: 3 }}>
                        <TextField
                            label='Buscar'
                            variant='outlined'
                            value={field}
                        ...
                        />
                        <Button variant='outlined' onClick={() => fecth({ field, skip: page * pageSize, limit: pageSize })} sx={{ p: 3.5 }}>
                            Buscar
                        </Button>
                        <Button variant='contained' onClick={() => { setField(''); fecth({ field: '', skip: 0, limit: pageSize }) }} sx={{ p: 3.5 }}>
                            Todos
                        </Button>
                    </Box>}
                        ...
                        rows.length === 0 ?
                            ...
                            >
                                <Typography variant="h4">
                                    Vehículos no disponibles en este momento
                                </Typography>
                            </Box> :
